...
class _ProfileScreenState extends State<ProfileScreen> {
                  ...
                  Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text('Name', style: TextStyle(color: kBlackColor, fontSize: 14, fontWeight: FontWeight.w600),),
                          Text('email@gmail.com', style: TextStyle(color: kGrey, fontSize: 13, fontWeight: FontWeight.w500),),
  ...
  Widget ListTileWidget(BuildContext context, {required IconData icon, required String text, VoidCallback? onListPressed}) {
    final mQ = MediaQuery.of(context).size;
    return
      Column(
        children: [
